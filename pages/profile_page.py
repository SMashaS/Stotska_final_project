...
class ProfilePage(BasePageWithDriver):
    ...
    def get_profile_side_menu_button(self):
        self._profile_side_menu_button = Button(self._driver.find_element(By.XPATH, "//a[@class='btn btn-white btn-sidebar sidebar_btn -profile']"))
    ...
    def get_profile_page_user_full_name_title(self):
        self._profile_page_user_full_name_title = Label(self._driver.find_element(By.XPATH, "//p[@class='profile_name display-4']"))
        return self._profile_page_user_full_name_title

    def get_profile_page_user_country_title(self):
        self._profile_page_user_country_title = Label(self._driver.find_element(By.XPATH, "//span[@class='icon icon-country']/following-sibling::span[@class='profile-info_text']"))
        return self._profile_page_user_country_title

    def get_profile_page_user_birthday_title(self):
        self._profile_page_user_birthday_title = Label(self._driver.find_element(By.XPATH, "//span[@class='icon icon-birthday']/following-sibling::span[@class='profile-info_text']"))
        return self._profile_page_user_birthday_title

    def get_profile_page_user_photo_img(self):
        self._profile_page_user_photo_img = ImageBox(self._driver.find_element(By.XPATH, "//img[@class='profile_photo']"))
    ...
    def get_edit_profile_name_is_required_alert(self):
        self._edit_profile_name_is_required_alert = Label(self._driver.find_element(By.XPATH, "//p[text()='Name is required']"))
        return self._edit_profile_name_is_required_alert

    def get_edit_profile_name_not_valid_data_alert(self):
        self._edit_profile_name_not_valid_data_alert = Label(self._driver.find_element(By.XPATH, "//p[text()='Name is invalid']"))
        return self._edit_profile_name_not_valid_data_alert

    def get_edit_profile_name_incorrect_data_alert(self):
        self._edit_profile_name_incorrect_data_alert = Label(self._driver.find_element(By.XPATH, "//p[text()='Name has to be from 2 to 20 characters long']"))
        return self._edit_profile_name_incorrect_data_alert

    def get_edit_profile_last_name_is_required_alert(self):
        self._edit_profile_last_name_is_required_alert = Label(self._driver.find_element(By.XPATH, "//p[text()='Last name is required']"))
        return self._edit_profile_last_name_is_required_alert

    def get_edit_profile_last_name_not_valid_data_alert(self):
        self._edit_profile_last_name_not_valid_data_alert = Label(self._driver.find_element(By.XPATH, "//p[text()='Last name is invalid']"))
        return self._edit_profile_last_name_not_valid_data_alert

    def get_edit_profile_last_name_incorrect_data_alert(self):
        self._edit_profile_last_name_incorrect_data_alert = Label(self._driver.find_element(By.XPATH, "//p[text()='Last name has to be from 2 to 20 characters long']"))
